...
public class Library {
    ...
    void LibrarianAddNewBook( String NewType, String NewAuthor ,String NewTitle ,String NewSubject , int quantity , int lib_id)
    {
        for (int i = 0; i < LibrarianList.size(); i++) {

            Librarian L = LibrarianList.get(i);
            if (L.getId() == lib_id) {
                L.AddBook(BooksList, NewType, NewAuthor, NewTitle, NewSubject, quantity);
            }
