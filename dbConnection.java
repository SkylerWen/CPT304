...
public class dbConnectivity {
    ...
    ArrayList<Books> LoadAllBooks() {
        ArrayList<Books> CurrentBooks = new ArrayList<Books>();
        try {
    ...
    ArrayList<User> LoadAllBorrowers() {
    ...
    ArrayList<Librarian> LoadAllLibrarian() {

        ArrayList<Librarian> CurrentLibrarian = new ArrayList<>();
        try {
